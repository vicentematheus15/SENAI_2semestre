...
INSERT INTO DEPARTAMENTO (NOME_DEPARTAMENTO) VALUES ('OPERACONAL');
...
BEGIN
	IF(OLD.SALARIO IS NULL) THEN
		...
		SAL_ANTERIOR, SAL_ATUAL) VALUES(NEW.MATRICULA, NOW(), 0.0, NEW.SALARIO);
	ELSE
		INSERT INTO ATUALIZACAO_SALARIAL(MATRICULA_FUNC, DATA_ALTERACAO,
		SAL_ANTERIOR, SAL_ATUAL) VALUES(NEW.MATRICULA, NOW(), OLD.SALARIO, NEW.SALARIO);
	END IF;
	RETURN NULL;
END;
$$ LANGUAGE PLPGSQL;
...
UPDATE FUNCIONARIO SET SALARIO = 5000.50
